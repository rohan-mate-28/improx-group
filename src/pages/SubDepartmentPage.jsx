  ...
  const getSubDepartmentArticles = (slug, name) => {
    ...
    const articleMatrix = {
      ...
      'business-strategy': [
        ...
        { title: 'The Anatomy of a High-Yield Competitive Position Framework', excerpt: 'Breaking down how data-backed matrices beat pure intuition when engineering long-term growth roadmaps.', date: 'June 02, 2026', readTime: '5 min read', tag: 'Analysis', image: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=600&auto=format&fit=crop' },
        { title: 'A Founder Guide to International Market Entry Timelines', excerpt: 'Mitigating compliance hurdles and foreign operational drag during enterprise scaling phases.', date: 'May 14, 2026', readTime: '9 min read', tag: 'Global Growth', image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=600&auto=format&fit=crop' }
      ],
      'management-consulting': [
        { title: 'Redesigning Org Structures for Post-Agile Workflows', excerpt: 'Why strict departmental silos break in remote environments, and how to introduce hybrid matrices.', date: 'June 11, 2026', readTime: '6 min read', tag: 'Management', image: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=600&auto=format&fit=crop' },
        { title: 'Change Management Playbooks That Actually Reduce Attrition', excerpt: 'Empathy-driven corporate restructuring techniques backed by operational psychology data.', date: 'May 24, 2026', readTime: '8 min read', tag: 'HR Strategy', image: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?q=80&w=600&auto=format&fit=crop' },
        { title: 'Audit Methodologies for Mid-Market Performance Bottlenecks', excerpt: 'How to run micro-interviews and activity tracking without introducing structural company friction.', date: 'May 03, 2026', readTime: '5 min read', tag: 'Operations', image: 'https://images.unsplash.com/photo-1542744094-3a31f103e35f?q=80&w=600&auto=format&fit=crop' }
      ],

      // Cloud Sub-departments
      'cloud-migration': [
        { title: 'Zero-Downtime Database Migration Frameworks for Enterprise Tech', excerpt: 'An in-depth technical analysis of live-replication pipelines moving local clusters directly to AWS.', date: 'June 19, 2026', readTime: '11 min read', tag: 'Architecture', image: 'https://images.unsplash.com/photo-1600132806370-bf17e65e942f?q=80&w=600&auto=format&fit=crop' },
        { title: 'Legacy Monolith to Microservices: The Re-Architecting Cost Formula', excerpt: 'How to precisely calculate if full-code factorization yields infrastructure savings or operational debt.', date: 'June 07, 2026', readTime: '8 min read', tag: 'Cloud Economics', image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=600&auto=format&fit=crop' },
        { title: 'Avoiding Post-Migration Sticker Shock in Multi-Cloud Spaces', excerpt: 'Configuring billing thresholds and dynamic computing resource limits before running data ingestions.', date: 'May 20, 2026', readTime: '6 min read', tag: 'FinOps', image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=600&auto=format&fit=crop' }
      ],
      'devops-cicd': [
        { title: 'Optimizing Kubernetes Cluster Orchestration for Variable Loads', excerpt: 'Fine-tuning horizontal pod autoscaling metrics to counter sudden API usage spikes smoothly.', date: 'June 14, 2026', readTime: '7 min read', tag: 'DevOps', image: 'https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?q=80&w=600&auto=format&fit=crop' },
        { title: 'Securing GitHub Action Runner Pipelines Against Vector Injections', excerpt: 'Hardening variables, isolation routines, and secret keys across public-facing enterprise builds.', date: 'May 28, 2026', readTime: '10 min read', tag: 'Security', image: 'https://images.unsplash.com/photo-1563986768494-0de2e4926784?q=80&w=600&auto=format&fit=crop' },
        { title: 'The Direct Metrics of Containerization Build Speeds', excerpt: 'Using smart layered caches in Docker to trim down compilation wait times from minutes to seconds.', date: 'May 11, 2026', readTime: '5 min read', tag: 'Automation', image: 'https://images.unsplash.com/photo-1618401471353-b98aedd07871?q=80&w=600&auto=format&fit=crop' }
      ],
      ...
      'data-engineering': [
        ...
        { title: 'Modern ETL vs ELT: Deciding On Storage Engine Compute Layers', excerpt: 'Evaluating real-time latency trade-offs when pushing transformation tasks down to storage servers.', date: 'June 01, 2026', readTime: '7 min read', tag: 'Pipelines', image: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?q=80&w=600&auto=format&fit=crop' },
        { title: 'Managing Schema Drift Across Unstructured Event Streams', excerpt: 'Using programmatic parsing rules to keep analytic dashboards from breaking during rapid upstream API updates.', date: 'May 19, 2026', readTime: '8 min read', tag: 'Architecture', image: 'https://images.unsplash.com/photo-1515879218367-8466d910aaa4?q=80&w=600&auto=format&fit=crop' }
      ],
      'data-science-ml': [
        ...
        { title: 'Mitigating Data Bias in Predictive Classification Engines', excerpt: 'Statistical verification routines to clear hidden historical anomalies from algorithmic training pools.', date: 'June 04, 2026', readTime: '8 min read', tag: 'AI Ethics', image: 'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?q=80&w=600&auto=format&fit=crop' },
        { title: 'MLOps Architectures for Zero-Downtime Model Hot Swaps', excerpt: 'Running safe shadow tests and canary routes against fresh model endpoints before full deployment.', date: 'May 22, 2026', readTime: '10 min read', tag: 'MLOps', image: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?q=80&w=600&auto=format&fit=crop' }
      ]
    };
  ...
  const getSubDepartmentTeasers = (slug) => {
    const imagesMap = {
      'business-strategy': [
        ...
        'https://images.unsplash.com/photo-1507537297725-24a1c029d3ca?q=80&w=500&auto=format&fit=crop',
      ...
      'management-consulting': [
        ...
        'https://images.unsplash.com/photo-1542744094-3a31f103e35f?q=80&w=500&auto=format&fit=crop',
      ...
      'devops-cicd': [
        ...
        'https://images.unsplash.com/photo-1618401471353-b98aedd07871?q=80&w=500&auto=format&fit=crop',
      ...
      'data-engineering': [
        ...
        'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?q=80&w=500&auto=format&fit=crop',
      ...
      'data-science-ml': [
        'https://images.unsplash.com/photo-1677442136019-21780efad99a?q=80&w=500&auto=format&fit=crop',
      ...
      'digital-marketing': [
        'https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?q=80&w=500&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=500&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1551836022-d5d88e9218df?q=80&w=500&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?q=80&w=500&auto=format&fit=crop'
      ],
      'software-development': [
        ...
        'https://images.unsplash.com/photo-1587620962725-abab7fe55159?q=80&w=500&auto=format&fit=crop'
      ],
      'cybersecurity': [
        'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=500&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1563986764494-0de2e4926784?q=80&w=500&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1614064641938-3bbee52942c7?q=80&w=500&auto=format&fit=crop',
        'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?q=80&w=500&auto=format&fit=crop'
      ],
    };

    // Safe industry defaults for any other unlisted parameters
    const baseFallbacks = [
      'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=500&auto=format&fit=crop',
  ...
  {/* ─── HERO SECTION ─── */}
      <section className="relative section-pad min-h-[60vh] flex items-center overflow-hidden bg-white">
        <div className="absolute inset-0">
          <img
            src={dept.image || "https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=1200&auto=format&fit=crop"}
            alt={subDept.name}
        ...
        <div className="container-max relative z-10 w-full">
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            {/* Right Classy Geometric Tech Canvas (Blank Side Filler Animation) */}
              ...
              <div className="relative w-72 h-72 sm:w-80 sm:h-80 flex items-center justify-center">
                ...
                >
                  <div className="w-full h-full rounded-full border border-dashed border-slate-200/40 relative">
                    {/* Tiny Node Orbs tracking along lines */}
      ...
      {/* ─── DETAILED OVERVIEW & FEATURES (DYNAMIC SUBDEPARTMENT CAPABILITIES) ─── */}
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {(dept.services || ['System Auditing', 'Infrastructure Design', 'Integration Architecture', 'Performance Yield Management']).slice(0, 4).map((service, idx) => (
                    <div key={idx} className="group/service rounded-2xl overflow-hidden border border-slate-100 bg-slate-50/50 flex flex-col h-full hover:border-slate-200 transition-all">
                      <div className="h-24 overflow-hidden bg-slate-200 relative">
                        <img 
            ...
            {articles.map((article, i) => (
              ...
              >
                ...
                <div className="h-44 overflow-hidden bg-slate-100 relative">
                  <img 
                    src={article.image || "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=600&auto=format&fit=crop"} 
                    alt={article.title}
